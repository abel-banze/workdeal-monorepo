        ...
        <div className="relative hidden overflow-hidden bg-[#0F1A2E] text-white lg:flex lg:flex-col">
          ...
          <div className="relative flex flex-1 flex-col px-10 py-8 xl:px-12">
            ...
            <div className="mt-10 flex-1">
              <p className="inline-flex rounded-full border border-white/15 bg-white/10 px-3 py-1 text-[11px] font-bold tracking-[0.14em] text-white/80">RECUPERAÇÃO SEGURA</p>
              <h1 className="mt-5 text-[36px] font-black leading-[0.9] tracking-[-0.05em] xl:text-[42px]" style={{ fontFamily: "var(--font-display)" }}>
                Sem stress.
                <br />
                <span className="font-light text-white/85">Recupera o acesso.</span>
              </h1>
              <p className="mt-4 max-w-[420px] text-[15px] leading-relaxed text-white/60">
                Enviamos um link único para o teu email. Válido por 1 hora, seguro e sem expor se a conta existe.
              </p>
              <div className="mt-8 space-y-3">
                {["Link enviado em segundos", "Token de uso único", "Sessões antigas mantidas por segurança"].map((t) => (
            ...
            <div className="flex items-center gap-2 pt-6 text-[11px] font-semibold tracking-[0.14em] text-white/30">
              <span>SEGURANÇA</span><span className="size-1 rounded-full bg-white/20" /><span>PRIVACIDADE</span><span className="size-1 rounded-full bg-white/20" /><span>CONFIANÇA</span>
            </div>
          </div>
        </div>
              ...
              <div className="rounded-[24px] border border-[#D9D2C2] bg-white p-6 shadow-[0_12px_40px_rgba(15,26,46,0.08)] sm:p-8">
                <div className="mb-6">
                  <div className="hidden lg:inline-flex items-center gap-2 rounded-full border border-[#0F1A2E]/10 bg-[#F6F3EE] px-3 py-1 text-[11px] font-bold tracking-[0.14em] text-[#0F1A2E]/60">
                    <span className="size-1.5 rounded-full bg-[#0B5E56]" /> RECUPERAR ACESSO
                  </div>
                  <h2 className="mt-3 text-[22px] font-black tracking-[-0.03em] text-[#0F1A2E]" style={{ fontFamily: "var(--font-display)" }}>Esqueceste a palavra-passe?</h2>
                  <p className="mt-1 text-sm text-[#0F1A2E]/60">Indica o email da tua conta e enviamos um link.</p>
                </div>
                <ForgotPasswordForm />
              </div>
