          ...
          <div className="relative flex flex-1 flex-col px-10 py-8 xl:px-12">
            ...
            <div className="mt-8 flex-1">
              ...
              >
                ...
                empresa
                <br />
                <span className="font-light text-white/85">mais longe.</span>
              </h1>
              <p className="mt-4 max-w-[420px] text-[15px] leading-relaxed text-white/60">
                Junte-se ao ecossistema onde empresas verificadas ganham visibilidade, confiança e clientes todos os dias.
              </p>

              <div className="mt-8 rounded-[20px] border border-white/10 bg-white p-3 shadow-[0_12px_32px_rgba(0,0,0,0.2)]">
                <div className="flex items-center justify-between px-1 pb-3">
                  <span className="text-[11px] font-bold tracking-[0.14em] text-[#0F1A2E]/40">A COMUNIDADE</span>
                  <span className="rounded-full bg-[#0B5E56] px-2.5 py-1 text-[10px] font-bold tracking-widest text-white">VERIFICADA</span>
                </div>
                <div className="grid gap-3">
                  <div className="flex items-center gap-3 rounded-xl border border-[#D9D2C2] bg-[#F6F3EE] p-3">
                    <span className="flex size-9 items-center justify-center rounded-full bg-[#0F1A2E] text-xs font-bold text-white">EC</span>
                    <div className="min-w-0 flex-1">
                      <p className="text-sm font-bold leading-none text-[#0F1A2E]">Elétrica Central</p>
                      <p className="text-xs text-[#0F1A2E]/60">Electricidade • Maputo • ★ 4.9</p>
                    </div>
                    <span className="rounded-full bg-[#0B5E56] px-2 py-1 text-[10px] font-bold text-white">OURO</span>
                  </div>
                  <div className="flex gap-2 text-xs">
                    <span className="inline-flex items-center gap-1.5 rounded-full bg-[#0F1A2E] px-3 py-1.5 font-semibold text-white">
                      <span className="size-1.5 rounded-full bg-[#0B5E56]" /> 3.400+ empresas activas
                    </span>
                    <span className="inline-flex items-center rounded-full border border-[#D9D2C2] bg-white px-3 py-1.5 font-semibold text-[#0F1A2E]">
                      8 sectores
                    </span>
                  </div>
                </div>
              ...
              <div className="mt-6 space-y-2.5">
                {[
                  "Perfil profissional em minutos",
                  "Selo de verificação que transmite confiança",
                  "Aparece para quem procura perto de si",
                ].map((t) => (
            ...
            <p className="pt-6 text-xs font-medium text-white/30">Sem fidelização • Suporte em pt-MZ • Contacto directo, sem comissões</p>
          </div>
        </div>
          ...
          <div className="flex flex-1 items-center justify-center px-4 py-8 sm:px-6 lg:px-10">
            <div className="w-full max-w-[480px]">
              <div className="rounded-[24px] border border-[#D9D2C2] bg-white p-6 shadow-[0_12px_40px_rgba(15,26,46,0.08)] sm:p-8">
                <div className="mb-6">
                  <div className="hidden lg:inline-flex items-center gap-2 rounded-full border border-[#0F1A2E]/10 bg-[#F6F3EE] px-3 py-1 text-[11px] font-bold tracking-[0.14em] text-[#0F1A2E]/60">
                    <span className="size-1.5 rounded-full bg-[#FF3B1F]" /> CRIAR CONTA GRATUITA
                  </div>
              ...
              <p className="mt-6 text-center text-sm text-[#0F1A2E]/60">
                Já tem conta?{" "}
                <Link href="/login" className="font-bold text-[#0F1A2E] hover:text-[#0B5E56]">
                  Entrar →
                </Link>
              </p>
