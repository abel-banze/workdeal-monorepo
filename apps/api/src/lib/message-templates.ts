...
export const WHATSAPP_TEMPLATES: MessageTemplate[] = [
  ...
  },
  {
    ...
    usedIn: ["services/quotes.service.ts via dispatcher (notifyQuoteReceived)"],
  },
  {
    key: "tasks_cta",
    channel: "whatsapp",
...
export const EMAIL_TEMPLATES: MessageTemplate[] = [
  ...
  },
  {
    ...
    usedIn: ["services/pre-register-notifications.service.ts (sendEmail)"],
  },
  {
    ...
    usedIn: ["services/negotiation-notifications.service.ts (via dispatcher)"],
  },
  {
  ...
  },
  {
    ...
    usedIn: ["services/tasks.service.ts (via dispatcher)"],
  },
  {
    key: "bid_awarded",
    channel: "email",
  ...
  },
  {
    ...
    usedIn: ["services/events.service.ts (via dispatcher)"],
  },
  {
    key: "event_interest",
    channel: "email",
  ...
  },
  {
    ...
    usedIn: ["services/support.service.ts (via dispatcher)"],
  },
];
